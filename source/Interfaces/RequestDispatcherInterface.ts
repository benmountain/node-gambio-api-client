interface RequestDispatcherInterface {
   ...
   * @returns {Promise} Request promise.
   */
  post(route: string, data: {}): Promise<{}>;
   ...
   * @returns {Promise} Request promise.
   */
  delete(route: string, data: {}): Promise<{}>;
   ...
   * @returns {Promise} Request promise.
   */
  uploadFile(route: string, filePath: string, filePostFieldName?: string, fileNamePostFieldName?: string): Promise<{}>;
}
