...
test('CategoryEndpointConnector#getChildrenById', t => reusableTesters.testEndpointConnectorCustomMethodWithRequiredParameter(t, instance, 'getChildrenById', variables.examples.number));
